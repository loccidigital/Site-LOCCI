...
import { Sparkles, Compass, CheckCircle2, AlertCircle, ArrowRight, Kanban, BarChart, Sliders } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16" id="metodo-intro">
          <span className="text-xs font-mono font-bold text-gold-500 uppercase tracking-widest bg-white/5 px-3 py-1.5 rounded-full border border-white/10">
            Metodologia Proprietária LOCCI
          </span>
          ...
          <p className="text-gold-500 font-medium text-sm mt-3 flex items-center justify-center gap-1">
            <Sparkles className="w-4 h-4" /> Nosso método transforma redes sociais em um sistema de percepção, relacionamento e conversão.
          </p>
        </div>
            ...
            <div className="bg-navy-950 p-6 rounded-xl border border-white/5 h-[280px] flex flex-col justify-between relative overflow-hidden">
              ...
              {activeContrastTab === "without" ? (
                <>
                  ...
                  {/* Loop graph simulator represent chaos */}
